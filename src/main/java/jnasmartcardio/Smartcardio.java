...
public class Smartcardio extends Provider {
  ...
  public static class JnaCardTerminals extends CardTerminals {
    ...
    /**
     * @param oldKnownReaders old list of known readers to copy state variables from.
    ...
    public String toString() {
      return String.format("%s{scardContext=%s}", getClass().getSimpleName(), scardContext);
    }
  ...
  public static class JnaCard extends Card {
    ...
    /**
     * @param controlCode one of the IOCTL_SMARTCARD_* constants from WinSmCrd.h
     */
    @Override
    ...
    @Override
    public String toString() {
      return String.format("%s{scardHandle=%s}", getClass().getSimpleName(), scardHandle);
    }
  }
